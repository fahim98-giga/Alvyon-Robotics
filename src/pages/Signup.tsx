    ...
    <div className="min-h-screen pt-32 pb-20 px-6 flex items-center justify-center">
      <div className="w-full max-w-md">
        <div className="text-center mb-12">
          ...
          <h1 className="text-3xl font-display font-bold mb-2">Join Alvyon BD</h1>
          <p className="text-white/40">Start building the future of robotics today</p>
        </div>

        <form onSubmit={handleSignup} className="glass p-8 rounded-[32px] border-white/5 space-y-6">
          ...
          <div className="relative py-4">
            ...
            <div className="relative flex justify-center text-xs uppercase"><span className="bg-transparent px-2 text-white/20">Or sign up with</span></div>
          </div>
        ...
        <p className="text-center mt-8 text-sm text-white/40">
          Already have an account? <Link to="/login" className="text-neon-blue font-bold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
